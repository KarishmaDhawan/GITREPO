...
headlabel = tk.Label(Tops, font=('lato black', 70, 'bold'), text='Currency converter',bg='#e6e5e5', fg='black')
...
Label_10=Button(root,text="EXIT",bg="lightblue",fg="white",font=("Cascadia Code SemiBold",20,"bold"),command=root.destroy)
Label_10.place(x=550,y=750)
